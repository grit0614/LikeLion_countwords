...
;(function($) {
  $.textcounter = function(el, options) {
    ...
    base.init = function() {
      ...
      base.$el.after('<span class="' + base.options.countContainerClass + '">' + counterText + '<span class="' + base.options.textCountClass + '" name="' + base.options.countContainerClass + '">' + counterNum + '</span></' + base.options.countContainerElement + '>');
    //   base.$el.after('<' + base.options.countContainerElement + ' class="' + base.options.countContainerClass + '">' + counterText + '<span class="' + base.options.textCountClass + '" name="' + base.options.countContainerClass + '" value="' + counterNum + '">' + counterNum + '</span></' + base.options.countContainerElement + '>');
      base.$el.after('<' + base.options.countContainerElement + ' class="' + base.options.countContainerClass + '">' + '<input type="hidden" name="' + base.options.countContainerClass + '" value="' + counterNum + '"></' + base.options.countContainerElement + '>');
    //   base.$el.after('<' + 'input type="hidden' + '" name=' + base.options.countContainerClass + ' value="' + counterNum + '>' + counterNum + '</input>');
      // bind input events
    ...
    base.setCount = function(count) {
      ...
      $countEl.children('input[name=' + base.options.countContainerClass + ']').val(count);
